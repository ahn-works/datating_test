...
class Spot10App extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => MaterialApp(
    ...
    theme: ThemeData(colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFFFF3B30), primary: const Color(0xFFFF3B30)), useMaterial3: true, fontFamily: 'Pretendard'),
...
class _MainNavigationState extends State<MainNavigation> {
  ...
  @override Widget build(BuildContext context) => Scaffold(
    ...
    bottomNavigationBar: BottomNavigationBar(
      ...
      selectedItemColor: const Color(0xFFFF3B30), unselectedItemColor: Colors.grey, type: BottomNavigationBarType.fixed,
      items: const [
