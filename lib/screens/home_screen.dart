...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('위피 버디', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 22)),
        backgroundColor: Colors.white,
        elevation: 0,
      ...
      body: ListView(
        ...
        children: [
          Padding(
            ...
            child: Container(
              ...
              child: const Column(
                ...
                children: [
                  Text('오늘의 동네 친구를 찾아보세요!', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                  SizedBox(height: 8),
                  Text('나와 가까운 친구들과 모임까지 한 번에!', style: TextStyle(color: Colors.white70, fontSize: 14)),
                ],
              ),
            ),
          ),
          ...
          const Padding(
            ...
            child: Text('오늘의 추천 친구', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          ),
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                _userCard(context, '지은', '광주 · 24세', 'https://picsum.photos/200/300?random=1'),
                _userCard(context, '수현', '광주 · 27세', 'https://picsum.photos/200/300?random=2'),
                _userCard(context, '민호', '목포 · 26세', 'https://picsum.photos/200/300?random=3'),
              ],
            ),
          ),
          const SizedBox(height: 32),
          ...
          const Padding(
            padding: EdgeInsets.symmetric(horizontal: 20),
            child: Text('서비스 둘러보기', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          ),
          const SizedBox(height: 16),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: Column(children: [
              _featureCard(Icons.travel_explore, '여행 모집', '지역기반 여행 모임 만들기', const Color(0xFFFF3B30)),
              const SizedBox(height: 12),
              _featureCard(Icons.people, '동네 커플', '남성/여성 성비 확인 후 참여', Colors.blue),
              const SizedBox(height: 12),
