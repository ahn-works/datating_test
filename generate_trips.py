...
nav_replace = """        BottomNavigationBarItem(
          icon: InkWell(
            onTap: () {
...
if "import 'oomu_my_trips_screen.dart';" not in home_code:
...
pattern = r'BottomNavigationBarItem\(\s*icon:\s*Icon\(Icons\.directions_car_outlined\).*?\),'
home_code = re.sub(pattern, nav_replace, home_code, flags=re.DOTALL)
